...
export function Sky() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      skyRef.current.rotation.x = 10; // Adjust speed as needed
  ...
  useEffect(() => {
    if (sky.scene) {
      ...
      skyRef.current.position.z = 0; // Adjust the z position to place it further away from the camera { this wil set the camera postion }
    }
  }, [sky.scene]);
